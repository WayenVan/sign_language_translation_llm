...
class TopdownHeatmapBaseHead(nn.Module):
    ...
    def decode(self, img_metas, output, **kwargs):
        raise NotImplementedError(
            "decode method is not implemented in TopdownHeatmapBaseHead. "
        )
...
class TopdownHeatmapSimpleHead(TopdownHeatmapBaseHead):
    ...
    def get_loss(self, output, target, target_weight):
        # return None
        raise NotImplementedError("there is no loss in this module")
    ...
    def get_accuracy(self, output, target, target_weight):
        raise NotImplementedError(
            "TopdownHeatmapSimpleHead does not support get_accuracy. "
        )
    ...
    def inference_model(self, x, flip_pairs=None):
        ...
        """
        raise NotImplementedError(
            "TopdownHeatmapSimpleHead does not support inference_model. "
        )
